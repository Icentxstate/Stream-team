...
# --- DETAIL VIEW ---
    ...
    # ✅ هشدار اگر هیچ پارامتری انتخاب نشده باشد
    if not selected:
...
with tab6:
    ...
    # اطمینان از نصب کتابخانه مورد نیاز
    try:
